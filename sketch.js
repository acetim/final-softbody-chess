var dek = false, count = 0, secret = [], postframecount = 0, grid = [], wk, bk;
//NO EN PASSANT CASTLEING AND SELF-DISCOVERED CHECK BLOCK 
...
////////////////////////////variables
var f = true, n = 20, selectedPiece = null, clickTimer = 0, turn = 'white';//remember to change turn
////////////////////////////
...
function mouseClicked() {
  if (postframecount > 20) {
    let x2 = mouseX
    let y2 = mouseY
    secret.push([(Math.floor(x2 / 100)), (Math.floor(y2 / 100))])//easter egg

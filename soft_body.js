...
checklock is called from piece and cheks each frame if the velocity is low enough and if the piece is bounded - if it is it locks the piece

bounds are added and removed whena piece is selected and a turn has ended

unlock occurs when a piece is selected
...
for (let i = 0; i < this.particles.length; i++) {
  ...
  checklock(){//checks is the  avg velocity is low enough to lock
